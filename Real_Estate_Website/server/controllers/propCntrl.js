import asynHandler from 'express-async-handler'
 ...
 export const createProperty = asynHandler(async(req, res) =>{
    ...
    const {title, description,price, address, city, country, image, facilities,
        brokerEmail} = req.body.data
...
export const deleteProperty = asynHandler(async (req, res)=>{
    ...
    const propertyExists = await prisma.properties.findUnique({  where: {id : id} });
